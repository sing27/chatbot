...
def timer():
    ...
    while running:
        ...
        if time.time() > time_started + X:
            ...
            final_transcript = ""   
            pause_event.set()
            continue  # or raise TimeoutException() continue
...
def listen_print_loop(responses: object) -> str:
    ...
    global final_transcript, time_started, time_check
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            # one of our keywords.
            if re.search(r"\b(再見|大師|master|死にゆく季節の君へ)\b", transcript, re.I):
                print("Good Bye!")
                break
...
def main() -> None:
 ...
 #   alternative_language_code = ['ja-JP', 'en-US']  # a BCP-47 language tag 'ja-JP' 'en-US' 'yue-Hant-HK' 'cmn-Hans-CN'
    ...
    config = speech.RecognitionConfig(
        ...
        alternative_language_codes=['en-US', 'yue-Hant-HK', 'ja-JP'],
